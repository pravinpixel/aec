var app = angular.module('App', ['dx','ui-notification','ngRoute','angularjs.daterangepicker','textAngular','luegg.directives','psi.sortable','ngSanitize']).constant('API_URL', $("#baseurl").val());   
