var app = angular.module('App', ['720kb.datepicker',,'dx','ui-notification','ngRoute','angularjs.daterangepicker','textAngular','luegg.directives','psi.sortable','ngSanitize']).constant('API_URL', $("#baseurl").val());   
