app.controller('CustomerprojectController', function ($scope, $http, API_URL, $compile) {
    ...
    var unestablish = $('#unestablished-table').DataTable({
        ...
        serverSide: true,
        ajax          : {
            url     :  API_URL +'customers/project-unestablished-list',
            dataType: 'json',
            data: function (d) {
    ...
    var live = $('#live-project-table').DataTable({
        ...
        serverSide: true,
        ajax          : {
            url     :  API_URL +'customers/project-live-list',
            dataType: 'json',
            data: function (d) {
              d.from_date      = $scope.from_date;
              d.to_date        = $scope.to_date;
