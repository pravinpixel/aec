...
app.controller('ToDoListController', function ($scope, $http, API_URL, $location) {
    ...
    $scope.add_new_check_list_item  =  ()   => { 
        ...
        $http.post(`${API_URL}admin/check-list-master-group`, {data:  $scope.check_list_type,  project_id:  $scope.project_id}).then((res) => {
...
app.controller('CustomerTicketController', function ($scope, $http, API_URL, $rootScope,$location,$timeout) {
