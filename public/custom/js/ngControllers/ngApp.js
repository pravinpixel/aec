var app = angular.module('App', ['ngMaterial', 'ngMessages', 'material.svgAssetsCache', '720kb.datepicker', 'ngRoute', 'datatables', 'luegg.directives', 'textAngular', 'psi.sortable', 'dx', 'angularjs.daterangepicker']).constant('API_URL', $("#baseurl").val());
