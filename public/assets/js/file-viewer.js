...
$.fn.EZView = function(){
    ...
    self.createContainer = function(){
        ...
        if (!$('#EZView').length) {
            ...
            var tools =
                '<div class="tools-container bg-white p-3">'+
                ...
                container = '<div class="object"/>'+
                        ...
                        tools,
                template = '<div id="EZView" class="hide" style="display: flex; align-items: center; justify-content: center">'+container+'</div>';
    ...
    self.builtObjectTemplate = function(index){
        console.log(arIndex[index].href)
