...
dataLabels && (labels = dataLabels.split(",") );
// dataSerires && (series = dataSerires);
let series = dataSerires.split(",").map(a => {return Number(a)} );
...
colors = ["#39afd1", "#ffbc00", "#163269", "#0acf97"];
(dataColors = $("#image-pie").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: {
        height: 320,
        type: "pie"
