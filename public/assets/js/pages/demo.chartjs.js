function hexToRGB(a, r) {
    ...
    a.prototype.respChart = function(r, t, e, o) {
        ...
        }))), 0 < d("#bar-chart-example").length && (n = (o = d("#bar-chart-example").data("colors")) ? o.split(",") : i.concat(), (r = document.getElementById("bar-chart-example").getContext("2d").createLinearGradient(0, 500, 0, 150)).addColorStop(0, n[0]), r.addColorStop(1, n[1]), t = {
        ...
        }))), 0 < d("#radar-chart-example").length && (s = {
            labels: ["Eating", "Drinking", "Sleeping", "Designing", "Coding", "Cycling", "Running"],
            datasets: [{
                label: "Desktops",
                backgroundColor: hexToRGB((n = (o = d("#radar-chart-example").data("colors")) ? o.split(",") : i.concat())[0], .2),
                borderColor: n[0],
        ...
        }, l.push(this.respChart(d("#radar-chart-example"), "Radar", s, {
            maintainAspectRatio: !1
        }))), l
