			...
			<div class="p-0">
				<div class="p-0">
					<div class="row justify-content-between bg-primary p-1 text-gray-900">
						...
						<h2 class="lblEnquiry p-2" id="lblTitle">New User</h2>
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" id="first_name" name="first_name" placeholder="Company Name" class="form-control form-control-sm mb-2" value="" />
													<span class="form-text text-muted"></span>
												</div>
												<div class="form-group">
													<label>Last Name<span class="text-danger">*</span></label>
													<input type="text" id="last_name" name="last_name" placeholder="Company Name" class="form-control form-control-sm mb-2" value="" />
													<span class="form-text text-muted"></span>
												</div>
												
												<div class="form-group">
													<label>Nick Name<span class="text-danger">*</span></label>
													<input type="text" id="nickname" name="nickname" placeholder="Company Name" class="form-control form-control-sm mb-2" value="" />
													<span class="form-text text-muted"></span>
												</div>
												<div class="form-group">
													<label>Company Mapped To<span class="text-danger">*</span></label>
													<input type="text" id="company_id" name="company_id" placeholder="Company Name" class="form-control form-control-sm mb-2" value="" />
													<span class="form-text text-muted"></span>
												</div>
												<div class="form-group">
													<label>Company Working On<span class="text-danger">*</span></label>
													<input type="text" id="company" name="company" placeholder="Company Name" class="form-control form-control-sm mb-2" value="" />
													<span class="form-text text-muted"></span>
												</div>
												<div class="form-group">
													<label>Job Title<span class="text-danger">*</span></label>
													<input type="text" id="job_title" name="job_title" placeholder="Company Name" class="form-control form-control-sm mb-2" value="" />
													<span class="form-text text-muted"></span>
												</div>
												<div class="form-group">
													<label>Industry<span class="text-danger">*</span></label>
													<input type="text" id="industry" name="industry" placeholder="Company Name" class="form-control form-control-sm mb-2" value="" />
													<span class="form-text text-muted"></span>
												</div>
												<div class="form-group">
													<label>About Me<span class="text-danger">*</span></label>
													<input type="text" id="about_me" name="about_me" placeholder="Company Name" class="form-control form-control-sm mb-2" value="" />
													<span class="form-text text-muted"></span>
												</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<div>
														<input type="file" id="image" name="image" class="form-control form-control-sm mb-2" placeholder="Project Name" value="" />
													</div>
													<span class="form-text text-muted"></span>
												</div>
												...
												<div class="form-group">
													...
													<input type="text" id="email" name="email" class="form-control form-control-sm mb-2" placeholder="Phone" value="" />
													<span class="form-text text-muted"></span>
												</div>
			
												<div class="form-group">
													<label>Phone<span class="text-danger">*</span></label>
													<input type="text" id="phone" name="phone" class="form-control form-control-sm mb-2" placeholder="Phone" value="" />
													<span class="form-text text-muted"></span>
												</div>
			
												<div class="form-group">
													<label>Address Line 1<span class="text-danger">*</span></label>
													<input type="text" id="address_line_1" name="address_line_1" class="form-control form-control-sm mb-2" placeholder="Address Line 1" value="" />
													<span class="form-text text-muted"></span>
												</div>
												<div class="form-group">
													<label>Address Line 2<span class="text-danger">*</span></label>
													<input type="text" id="address_line_2" name="address_line_2" class="form-control form-control-sm mb-2" placeholder="Address Line 2" value="" />
													<span class="form-text text-muted"></span>
												</div>
												<div class="row">
													<div class="col">
														<div class="form-group">
															...
															<input type="text" id="city" name="city" class="form-control form-control-sm mb-2" placeholder="City" value="" />
															<span class="form-text text-muted"></span>
														</div>
													</div>
													<div class="col">
														<div class="form-group">
															...
															<input type="text" id="postal_code" name="postal_code" class="form-control form-control-sm mb-2" placeholder="Postal Code" value="" />
															<span class="form-text text-muted"></span>
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<select id="state_or_province" name="state_or_province" class="form-control form-control-sm mb-2">
												...
												<div class="form-group">
													...
													<select name="country" id="country" onchange="loadStatesSelectItems();" class="form-control form-control-sm mb-2">
