							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input type="text" id="name" name="name" placeholder="Company Name" class="form-control form-control-solid form-control-lg" value="" />
										<span class="form-text text-muted"></span>
									</div>

									<div class="form-group">
										<label>Description<span class="text-danger">*</span></label>
										<input type="text" id="description" name="description" placeholder="Company Name" class="form-control form-control-solid form-control-lg" value="" />
										<span class="form-text text-muted"></span>
									</div>

									<div class="form-group">
										<label>Trade<span class="text-danger">*</span></label>
										<select name="trade" id="trade" class="form-control form-control-solid form-control-lg">
									...
									<div class="form-group">
										...
										<input type="text" id="erp_id" name="erp_id" placeholder="ERP Id" class="form-control form-control-solid form-control-lg" value="" />
										<span class="form-text text-muted"></span>
									</div>
									<div class="form-group">
										<label>Tax Id<span class="text-danger">*</span></label>
										<input type="text" id="tax_id" name="tax_id" placeholder="Tax Id" class="form-control form-control-solid form-control-lg" value="" />
										<span class="form-text text-muted"></span>
									</div>
									...
									<div class="form-group">
										...
										<input type="text" id="website_url" name="website_url" class="form-control form-control-solid form-control-lg" placeholder="Website URL" value="" />
										<span class="form-text text-muted"></span>
									</div>
								</div>
								<div class="col-sm-6">
