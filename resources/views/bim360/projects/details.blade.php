...
<div class="p-0">
	<div class="p-0">
		<div class="row justify-content-between bg-primary p-1 text-gray-900">
			...
			<h2 class="lblEnquiry p-2" id="lblEnquiryNo">Project Detail - "{{ $data->name }}"</h2>
				...
				<div class="wizard-steps">
					...
					<div class="wizard-step" data-wizard-type="step">
						<div class="wizard-label">
							...
							<h3 class="wizard-title">2. Members</h3>
						</div>
						<span class="svg-icon svg-icon-xl wizard-arrow">
							<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
				...
				<div class="col-xl-12 col-xl-7">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<input type="text" readonly="readonly" id="name" name="name" placeholder="Project Name" class="form-control form-control-solid form-control-lg" value="" />
										<span class="form-text text-muted"></span>
									</div>

									<div class="form-group">
										<label>Project Type<span class="text-danger">*</span></label>
										<select disabled="disabled" name="project_type" id="project_type" class="form-control form-control-solid form-control-lg">
									...
									<div class="form-group">
										...
										<select disabled="disabled" name="construction_type" id="construction_type" class="form-control form-control-solid form-control-lg">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="number" readonly="readonly" id="value" class="form-control form-control-solid form-control-lg" name="value" placeholder="Project Value" value="" />
											<div class="input-group-append">
												<select disabled="disabled" id="currency" name="currency" class="form-control form-control-solid form-control-lg">
													<?php
									...
									<div class="form-group">
										...
										<select disabled="disabled" name="contract_type" id="contract_type" class="form-control form-control-solid form-control-lg">
									...
									<div class="row">
										<div class="col">
											<div class="form-group">
												...
												<input type="date" readonly="readonly" id="start_date" name="start_date" class="form-control form-control-solid form-control-lg" placeholder="Project Start Date" value="" />
												<span class="form-text text-muted"></span>
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												...
												<input type="date" readonly="readonly" id="end_date" name="end_date" class="form-control form-control-solid form-control-lg" placeholder="Project End Date" value="" />
												<span class="form-text text-muted"></span>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<input type="text" readonly="readonly" id="job_number" name="job_number" class="form-control form-control-solid form-control-lg" placeholder="Project Job Number" value="" />
										<span class="form-text text-muted"></span>
									</div>
									<!-- <div class="form-group">
										<label>Business Unit<span class="text-danger">*</span></label>
										<select disabled="disabled" id="business_unit_id" name="business_unit_id" class="form-control form-control-solid form-control-lg">
									...
									<div class="form-group">
										...
										<input type="text" readonly="readonly" name="service_types" id="service_types" class="form-control form-control-solid form-control-lg" value="" />
										<span class="form-text text-muted"></span>
									</div>

									<div class="form-group">
										<label>Status<span class="text-danger"></span></label>
										<select disabled="disabled" name="status" id="status" class="form-control form-control-solid form-control-lg">
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<input type="text" readonly="readonly" id="address_line_1" name="address_line_1" class="form-control form-control-solid form-control-lg" placeholder="Project Address Line 1" value="" />
										<span class="form-text text-muted"></span>
									</div>
									<div class="form-group">
										<label>Project Address Line 2<span class="text-danger">*</span></label>
										<input type="text" readonly="readonly" id="address_line_2" name="address_line_2" class="form-control form-control-solid form-control-lg" placeholder="Project Address Line 2" value="" />
										<span class="form-text text-muted"></span>
									</div>
									<div class="row">
										<div class="col">
											<div class="form-group">
												...
												<input type="text" readonly="readonly" id="city" name="city" class="form-control form-control-solid form-control-lg" placeholder="City" value="" />
												<span class="form-text text-muted"></span>
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												...
												<input type="text" readonly="readonly" id="postal_code" name="postal_code" class="form-control form-control-solid form-control-lg" placeholder="Postal Code" value="" />
												<span class="form-text text-muted"></span>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<select disabled="disabled" id="timezone" name="timezone" class="form-control form-control-solid form-control-lg">
									...
									<div class="form-group">
										...
										<select disabled="disabled" name="language" id="language" class="form-control form-control-solid form-control-lg">
									...
									<div class="row">
										<div class="col">
											<div class="form-group">
												...
												<input type="text" readonly="readonly" id="created_at" name="created_at" readonly="readonly" class="form-control form-control-solid form-control-lg" placeholder="Project Start Date" value="" />
												<span class="form-text text-muted"></span>
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												...
												<input type="text" readonly="readonly" id="updated_at" name="updated_at" readonly="readonly" class="form-control form-control-solid form-control-lg" placeholder="Project End Date" value="" />
												<span class="form-text text-muted"></span>
											</div>
										</div>
									</div>
					...
					<div class="pb-0" data-wizard-type="step-content">
						<div class="card card-custom">
							<div class="card-body">
								<a class="btn btn-primary" href="{{ route('/bim360/projects/create') }}">Create Member</a>
								<hr class="my-4" />
								<table id="tblMemberList" class="display stripe" style="width:100%">
					...
					<div class="d-flex justify-content-between border-top mt-5 pt-10">
						...
						<div>
							<button type="button" class="btn btn-primary font-weight-bolder text-uppercase px-9 py-4" onclick="PrevStep();">Previous</button>
							<button type="button" class="btn btn-primary font-weight-bolder text-uppercase px-9 py-4" onclick="NextStep();">Next</button>
						</div>
					</div>
					<!--end::Wizard Actions-->
...
<script>
	function init() {
		...
		// document.getElementById("business_unit_id").value='{{ $data->business_unit_id }}';
		// document.getElementById("last_sign_in").value='{{ $data->last_sign_in }}';
		// projectinfo.copy_project_job_id = document.getElementById("copy_project_job_id").value;
		// projectinfo.template_project_id = document.getElementById("template_project_id").value;
		// projectinfo.include_companies = document.getElementById("include_companies").value;
		// projectinfo.include_locations = document.getElementById("include_locations").value;
	...
	function IsCurrentStepValid() {
		var valid = true;
		// Do you step wise validation here
		return valid;
	}

	function DisableAllSteps() {
		$('[data-wizard-state="current"]').each(function(index, elem) {
			$(this).removeAttr("data-wizard-state");
		});

	}

	function EnableCurrentStep() {
		var steps = $('[data-wizard-type="step"]');
		for (var i = 0; i < steps.length; i++) {
			if (CurrentStep == i + 1) {
				$(steps[i]).attr("data-wizard-state", "current");
			}
		}

		var stepContents = $('[data-wizard-type="step-content"]');
		for (var i = 0; i < steps.length; i++) {
			if (CurrentStep == i + 1) {
				$(stepContents[i]).attr("data-wizard-state", "current");
			}
		}
	...
	function ShowHideActionButtons() {
		if (CurrentStep == 1) {
			$('[onclick="PrevStep();"]').each(function(index, elem) {
				$(this).hide();
			});
		} else {
			$('[onclick="PrevStep();"]').each(function(index, elem) {
		...
		if (CurrentStep == TotalSteps) {
			$('[onclick="NextStep();"]').each(function(index, elem) {
				$(this).hide();
			});
		} else {
			$('[onclick="NextStep();"]').each(function(index, elem) {
	...
	function fillMemberList(projectdata) {
		memberListTable = $('#tblMemberList').DataTable({
			data: projectdata,
			paging: true,
			searching: true,
			ordering: true,
	...
	function loadMemberList() {
		...
		$.ajax({
			url: "{{ route('/bim360/projects/getprojectusers') }}",
			type: 'post',
			data: fd,
			contentType: false,
			processData: false,
			success: function(response) {
				...
				fillMemberList(response.results);
			},
		});
	}
	...
	function fillCompanyList(projectdata) {
	...
	function loadCompanyList() {
		...
		fd.append('id', '{{ $data->id }}');
		$.ajax({
			url: "{{ route('/bim360/projects/getcompanies') }}",
			type: 'post',
			data: fd,
			contentType: false,
			processData: false,
