                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <div ng-controller="CompnayInfo" class="pt-3">
                            <form class="form-horizontal m-0  row" method="post" action="{{ route('company-info', $data['id']) }}">
                                @csrf
                                ...
                                <div class="mb-3 col-lg-6">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input class="form-control" type="text" onkeypress="return isNumber(event)" maxlength="12" minlength="8" name="mobile_no" id="mobile_no" pattern="{{ config('global.mobile_no_pattern') }}" value="{{ old('mobile_no') }}"  required placeholder="Enter mobile no">
                                      </div>
                                ...
                                <div class="mb-3 col-lg-6">
                                    ...
                                    <input class="form-control" type="url" name="website" id="website" value="{{ old('website') }}"  placeholder="Enter wesite url">
...
<script>
    app.controller('CompnayInfo', function ($scope, $http, $rootScope, Notification, API_URL) {
        $scope.getCompany = (text) => {
            $http.get(`https://hotell.difi.no/api/json/brreg/enhetsregisteret?query=${text}`).then(function successCallback(res){
