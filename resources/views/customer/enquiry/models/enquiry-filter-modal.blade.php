                ...
                <div >
                    ...
                    <div class="mb-3 row mx-0">
                        ...
                        <div class="col p-0 me-md-2">
                            ...
                            <input type="text" class="form-control date"  data-toggle="date-picker" data-single-date-picker="true" ng-model="enquiry_from_date" name="enquiry_from_date">
                        </div>
                        <div class="col p-0">
                            <label class="form-label">End Date</label>
                            <input type="text" class="form-control date"  data-toggle="date-picker" data-single-date-picker="true" ng-model="enquiry_to_date" name="enquiry_from_date">
                        </div>
                    </div>
