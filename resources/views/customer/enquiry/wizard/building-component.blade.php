                                        ...
                                        <tr>
                                            ...
                                            <th  class="bg-light">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="number" min="0" step="0.01" onkeypress="return isNumber(event)" class="form-control form-control-sm my-2  mt-3" name="TotalArea_@{{ fIndex }}_@{{ Secindex }}" ng-model="d.TotalArea" required>
                                                        ...
                                                        <div class="col p-0"> 
                                                            <div class="btn-group shadow-sm border rounded">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input  type="number" min="0" step="0.01" onkeypress="return isNumber(event)" class="form-control rounded-0 rounded-start  border-0 form-control-sm" name="Thickness_@{{ fIndex }}_@{{ Secindex }}_@{{ ThreeIndex }}" ng-model="l.Thickness " required >
