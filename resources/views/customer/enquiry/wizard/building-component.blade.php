<form class="row" id="buildingComponent" name="buildingComponentForm" novalidate>
    ...
    <div class="card-footer border-0 p-0 " >
        <ul class="list-inline wizard mb-0 pt-3">
            ...
            <li class="next list-inline-item float-end mx-2"><input class="btn btn-light border shadow-sm" g-show="showHideBuildingComponent == 0" ng-click="saveAndSubmitBuildingComponent()" type="button" name="submit"  value="Save & Submit Later"/></li>
        </ul>
    </div>
</form>
<style>
