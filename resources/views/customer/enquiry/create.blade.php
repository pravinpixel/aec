                             ...
                             <ul class="nav nav-pills nav-justified form-wizard-header bg-light ">
                                 <li class="nav-item projectInfoForm" data-target-form="#projectInfoForm">
                                     <a href="#!/" style="min-height: 40px;" class="timeline-step" id="project-info"
                                         ng-class="{project_information_w: project_information_w == 1}">
                                 ...
                                 <li class="nav-item serviceSelection" ng-click="updateWizardStatus(1)"
                                     data-target-form="#serviceSelection"
                                     ng-class="{service_selection_w: service_selection_w == 1}">
                                 ...
                                 <li class="nav-item IFCModelUpload" ng-click="updateWizardStatus(2)"
                                     data-target-form="#IFCModelUpload" ng-class="{ifc_model_w: ifc_model_w == 1}">
                                     <a href="#!/ifc-model-upload" style="min-height: 40px;" class="timeline-step"
                                         id="ifc-model-upload">
                                         <div class="timeline-content">
                                             <div class="inner-circle  bg-secondary">
                                 ...
                                 <li class="nav-item buildingComponent" ng-click="updateWizardStatus(3)"
                                     data-target-form="#buildingComponent"
                                     ng-class="{building_component_w: building_component_w == 1}">
                                     <a href="#!/building-component" style="min-height: 40px;" class="timeline-step"
                                 ...
                                 <li class="nav-item additionalInformation" ng-click="updateWizardStatus(4)"
                                     data-target-form="#additionalInformation"
                                     ng-class="{additional_info_w: additional_info_w == 1}">
                                     <a href="#!/additional-info" style="min-height: 40px;" class="timeline-step"
                                         id="additional-info">
                                         <div class="timeline-content">
                                             <div class="inner-circle  bg-secondary">
                                 ...
                                 <li class="nav-item last reviewSubmit" ng-click="updateWizardStatus(5)"
                                     data-target-form="#reviewSubmit" ng-class="{review_w: review_w == 1}">
         ...
         <script>
             ...
             app.controller('ProjectInfo', function($scope, $http, $rootScope, Notification, API_URL, $location, ) {
                 ...
                 getProjectInfoInptuDataFormat = function($projectInfo) {
                     ...
                     var new_projectDate=projectDate.split('-').reverse().join('-');
                     var projectDeliveryDate=$projectInfo.project_delivery_date;
                     var new_projectDeliveryDate=projectDeliveryDate.split('-').reverse().join('-');
                     $scope.data = {
                         'contact_person': $projectInfo.contact_person,
                         'mobile_no': $projectInfo.mobile_no,
                         'secondary_mobile_no': $projectInfo.secondary_mobile_no,
                         ...
                         'building_type_id': $projectInfo.building_type_id,
                         'project_type_id': $projectInfo.project_type_id,
                         'project_date': new_projectDate,
                         'site_address': $projectInfo.site_address,
                         'place': $projectInfo.place,
                         'country': $projectInfo.country,
                         'no_of_building': $projectInfo.no_of_building,
                         'delivery_type_id': $projectInfo.delivery_type_id,
                         'project_delivery_date': new_projectDeliveryDate,
                     };
                     return $scope.data;
                 }
                 getLastEnquiry = (enquiry_id) => {
                 ...
                 $scope.submitProjectInfoForm = (formValid) => {
                     ...
                     $http({
                         ...
                         data: {
                             type: 'project_info',
                             'data': getProjectInfoInptuData($scope.projectInfo)
                         }
                     }).then(function(res) {
             ...
             app.controller('Service', function($scope, $http, $rootScope, Notification, API_URL, $location) {
                 ...
                 $scope.changeService = function(list, active) {
                     if (active) {
                         ...
                         if ($scope.serviceList.indexOf(list) > -1) $scope.serviceList.splice($scope.serviceList
                             .indexOf(list), 1);
                     }
                 ...
                 $scope.submitService = (formValid) => {
                     ...
                     $http({
                         ...
                         data: {
                             type: 'services',
                             'data': getServiceSelectionInptuData()
                         }
                     }).then(function(res) {
             ...
             app.controller('BuildingComponent', function($scope, $http, $rootScope, Notification, API_URL, $location,
                 ...
                 $scope.submitTemplate = () => {
                     ...
                     $http({
                         ...
                         data: {
                             ...$scope.templateData,
                             data: data,
                             template_name: $scope.TemplateForm.name
                         }
                     }).then(function successCallback(response) {
                 ...
                 $scope.submitLayer = () => {
                     ...
                     $http({
                         ...
                         data: {
                             building_component_id: building_component_id,
                 ...
                 getLastEnquiry = (enquiry_id) => {
                     ...
                     $http({
                         ...
                         if (res.data.building_component.length == 0 || res.data
                                 ...
                                 Details = item.detail.map((detail, index) => {
                                     ...
                                     if (typeof(detail.layer) != 'undefined') {
                                         Layer = detail.layer.map((layerObj, index) => {
                                             ...
                                             return {
                                                 LayerName: String(layerObj
                                                     .layer_name),
                                                 // LayerNameText:  layerObj.layer.layer_name,
                                                 Thickness: Number(layerObj
                                                     .thickness),
                         ...
                         $scope.wallGroup.forEach((wall) => {
                             if (wall.Details.length > 0) {
                                 ...
                                 wall.Details.forEach((detail, index) => {
                                     wallIndex = index + 1;
                                     if (detail.FloorName == '' || typeof(detail.FloorName) ==
                                         'undefined') {
                                         Message('danger',
                                     ...
                                     if (detail.DeliveryType == '' || typeof(detail.DeliveryType) ==
                                         'undefined') {
                                         Message('danger',
                                             `${wallName} ${wallIndex} field required `);
                                         isValidField = false;
                                     ...
                                     if (detail.Layers.length > 0) {
                                         detail.Layers.forEach((layer) => {
                                             if (layer.LayerName == '' || typeof(layer
                                                     .LayerName) == 'undefined') {
                                                 Message('danger',
                                                     `${wallName} ${wallIndex} field required `
                                                 );
                                 ...
                                 if (result.isConfirmed) {
                                     $http({
                                         ...
                                         data: {
                                             ...
                                             'data': $scope.wallGroup
                                         }
                                     }).then(function(res) {
                                         $location.path('/additional-info')
                                         Message('success',
                                             `Building Component updated successfully`);
                                     }, function(error) {
                     ...
                     link: function(scope, element, attrs) {
                         scope.$watch('layerAdd', function() {
                             $http({
                                 ...
                                 params: {
                                     building_component_id: scope.w.WallId
                                 }
                             }).then(function success(response) {
             ...
             app.controller('AdditionalInfo', function($scope, $http, $rootScope, Notification, API_URL, $location) {
                 ...
                 getLastEnquiry = (enquiry_id) => {
                     ...
                     $http({
                         ...
                         enableActiveTabs(res.data.active_tabs);
                         $scope.additionalInfo = res.data.additional_infos == null ? '' : res.data
                         ...
                         $scope.htmlEditorOptions = {
                             ...
                             toolbar: {
                                 items: [
                                     ...
                                     'separator', 'bold', 'italic', 'strike', 'underline',
                                     'separator',
                 ...
                 $scope.saveAndSubmitAdditionalinfoForm = () => {
                     ...
                     $http({
                         ...
                         data: {
                             type: 'additional_info',
                             'data': document.getElementsByClassName('ck-content')[0].innerHTML
                         }
                     }).then(function(res) {
                 ...
                 $scope.showCommentsToggle = function(modalstate, type, header) {
                     ...
                     switch (modalstate) {
                         case 'viewConversations':
                             $http.get(API_URL + 'admin/show-comments/' + enquiry_id + '/type/' + type).then(
                                 function(response) {
             ...
             app.controller('IFCModelUpload', function($scope, $http, $rootScope, Notification, API_URL, $timeout, $location,
                 fileUpload) {
                 $scope.commentShow = false;
                 ...
                 getIFCViewList = (id, view_type) => {
                     ...
                     $http({
                         ...
                         if ($scope.mandatory.indexOf(view_type) > -1) $scope.mandatory.splice($scope
                             .mandatory.indexOf(view_type), 1);
                         $scope.documentLists[`${view_type}`] = [...$scope.documentLists[`${view_type}`], ...
                             res.data
                         ];
                     }, function(error) {
                         console.log(
                 ...
                 $scope.submitIFC = () => {
                     $http({
                         ...
                         url: '{{ route('customers.store-enquiry') }}',
                         data: {
                             type: 'ifc_model_upload_mandatory',
                             'data': false
                         }
                     }).then(function(res) {
                         if (res.data.status == false) {
                                ...
                                `,
                                     ...
                                     if (result.isConfirmed) {
                                         ...
                                         $timeout(function() {
                                             ...
                                             Message('success',
                                                 `IFC Models updated successfully`);
                                         });
                     ...
                     link: function($scope, element, attrs) {
                         element.bind('change', function() {
                             ...
                             promise.then(function(response) {
                                 ...
                                 console.log($scope);
                                 Message('success',
                                     `${file_type.replaceAll('_',' ')} uploaded successfully`);
                                 getIFCViewList(response.data, file_type);
                             }, function() {
                                 $scope.serverResponse = 'An error has occurred';
                             });
