                    ...
                    <div id="rootwizard" ng-controller="wizard">
                        ...
                        <div class="tab-content my-3" >
                            ...
                            <div class="tab-pane fade " id="second" ng-controller="ServiceSelection">
                                @include('customer.enquiry.create.service-selection')
                            </div>
                            <div class="tab-pane fade " id="four" ng-controller="IFCModelUpload">
                                @include('customer.enquiry.create.ifc-model-uploads')
                            </div> 

                            <div class="tab-pane p-0 h-100 fade " id="five" ng-controller="CrudCtrl">
                                @include('customer.enquiry.create.building-component')
                            </div>
                            ...
                            <div class="card-footer border-0 p-0 " >
                                <ul class="list-inline wizard mb-0 pt-3">
                                    ...
                                    <li class="next list-inline-item float-end" ng-show="currentStep <= 4" id="next_" ng-click="gotoStep(currentStep + 1)" ><a href="#" class="btn btn-primary">Next</a></li>
...
@push('custom-scripts')
    ...
    <script>
        ...
        app.controller('ServiceSelection', function ($scope, $http, $rootScope, Notification) {
           ...
           let outputTypefireOnce = false;
           $scope.getOutputTypes = () => {
