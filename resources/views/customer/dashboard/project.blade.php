                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table custom-responsive table-m">
                                            <table class="table custom custom table-sm table-centered mb-0 font-14">
                                                <thead class="table custom-light">
                                                    <tr>
                                                        <th>S:NO</th>
                                                        <th>Project Name</th>
                                                        <th>Enquiry date</th>
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6 shadow py-4">
                                                                            ...
                                                                            <div id="average-sales" class="apex-charts mb-4 mt-4"data-colors="#163269,#0acf97,#cc001a,#ffbc00"></div>
                                                                        </div>
                                                                        <div class="col-md-6">
