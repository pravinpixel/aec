                ...
                <table class="table m-0 table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="30px">
                                <button type="button" class="btn-primary rounded" onclick="createLiveProjectSubTask('{{ $sub_task->id }}', '{{ slugable($sub_task->name,$sub_task->id) }}',this)"><i class="mdi mdi-plus"></i></button>
                            </th>
                        </tr>
                    </thead>
