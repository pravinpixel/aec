...
<body>
    ...
    @if (session()->get('flash_notification'))
        @foreach (session()->get('flash_notification')->toArray() as $message)
            <script>
                Alert.{{ $message['level'] == 'danger' ? 'error' : $message['level'] }}("{!! $message['message'] !!}")
            </script>
        @endforeach
    @endif
    <div class="modal fade" id="EnquiryQuickViewPopUp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal fade" id="ProjectQuickViewPopUp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-right w-100">
            <div class="modal-content h-100 p-0" style="overflow: auto">
    ...
    <div class="modal fade" id="LiveProjectQuickViewPopUp" data-bs-backdrop="static" data-bs-keyboard="false"
