    ...
    <div class="header gantt-demo-header">
        <ul class="gantt-controls bg-light">
            ...
            <li class="gantt-menu-item"><a data-action="undo">
                    <img src="https://dhtmlx.com/docs/products/dhtmlxGantt/demo/imgs/ic_undo_24.png">
                    Undo
                </a>
            </li>
            <li class="gantt-menu-item"><a data-action="redo">
                    <img src="https://dhtmlx.com/docs/products/dhtmlxGantt/demo/imgs/ic_redo_24.png">
                    Redo
                </a>
            </li>
            <li id="fullscreen_button" class="gantt-menu-item  gantt-menu-item-last">
                <a>
...
@push('live-project-custom-scripts')
    ...
    <script type="text/javascript">
        document.addEventListener("DOMContentLoaded", function() {
            $('#gantt-container').removeClass('d-none')
            ...
            ganttModules.zoomToFit = (function(gantt) {
                ...
                function applyConfig(config, dates) {
                    ...
                    if (dates && dates.start_date && dates.start_date) {
                        gantt.config.start_date = gantt.date.add(dates.start_date, -1, config.scales[0]
                            .subscale_unit);
                        gantt.config.end_date = gantt.date.add(gantt.date[config.scales[0].subscale_unit +
                            "_start"](
                            dates.end_date), 2, config.scales[0].subscale_unit);
                    } else {
                ...
                function zoomToFit() {
                    ...
                    for (var i = 0; i < scaleConfigs.length; i++) {
                        var columnCount = getUnitsBetween(project.start_date, project.end_date,
                            scaleConfigs[i].scales[
                                0].subscale_unit, scaleConfigs[i].scales[0].step);
                ...
                var scaleConfigs = [
                        ...
                        scales: [{
                            ...
                            },
                            {
                                ...
                                template: function(date) {
                                    ...
                                    var endDate = gantt.date.add(gantt.date.add(date, 3,
                                            "month"), -1,
                                        "day");
                                    return dateToStr(date) + " - " + dateToStr(endDate);
                                }
                        ...
                        scales: [{
                            ...
                            },
                            {
                                ...
                                template: function(date) {
                                    ...
                                    var endDate = gantt.date.add(gantt.date.add(date, 5,
                                            "year"), -1,
                                        "day");
                                    return dateToStr(date) + " - " + dateToStr(endDate);
                                }
                    ...
                    // decades
                    {
                        scales: [{
                                ...
                                template: function(date) {
                                    var dateToStr = gantt.date.date_to_str("%Y");
                                    var endDate = gantt.date.add(gantt.date.add(date, 10,
                                            "year"), -1,
                                        "day");
                                    return dateToStr(date) + " - " + dateToStr(endDate);
                                }
                            },
                            {
                                ...
                                template: function(date) {
                                    var dateToStr = gantt.date.date_to_str("%Y");
                                    var endDate = gantt.date.add(gantt.date.add(date, 100,
                                            "year"), -1,
                                        "day");
                                    return dateToStr(date) + " - " + dateToStr(endDate);
                                }
            ...
            ganttModules.menu = (function() {
                ...
                function removeClass(node, className) {
                    node.className = node.className.replace(new RegExp(" *" + className.replace(/\-/g,
                            "\\-"), "g"),
                        "");
                }
                ...
                var menu = {
                    ...
                    toggleCriticalPath: function() {
                        gantt.config.highlight_critical_path = !gantt.config
                ...
                return {
                    setup: function() {
                        ...
                        gantt.event(navBar, "click", function(e) {
                            ...
                            while (!target.hasAttribute("data-action") && target !== document
                                .body) {
