        ...
        <div class="row g-2">
            <div class="col">
                <div class="card shadow-sm border" style="height:350px;overflow-y:auto">
                    ...
                    <div class="card-body"> 
                        {!! $project->projectComments->external ?? "" !!}
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card border shadow-sm" style="height:350px;overflow-y:auto">
                    ...
                    <div class="card-body">
                        <textarea id="admin-editor" name="internal" class="opacity-0">{!! $project->projectComments->internal ?? "" !!}</textarea>
                    </div>
                </div> 
            </div>
        </div>
        ...
        <div class="row g-2">
            <div class="col">
                <div class="card shadow-sm border" style="height:350px;overflow-y:auto">
                    ...
                    <div class="card-body">
                        {!! $project->projectComments->internal ?? "" !!}
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card border shadow-sm" style="height:350px;overflow-y:auto">
                    ...
                    <div class="card-body ">
                        <textarea id="admin-editor" name="external" height="100%" class="opacity-0">{!! $project->projectComments->external ?? "" !!}</textarea>
                    </div>
                </div>
            </div>
        </div>
