    ...
    <tbody>
        <tr ng-repeat="(fIndex,profile) in Profiles">
            ...
            <td class="text-center">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Part_wall_model__@{{ fIndex }}"><i class="fa fa-pencil"></i></button>
                <div id="Part_wall_model__@{{ fIndex }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="Part_wall_modelLabel__@{{ fIndex }}" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header modal-colored-header bg-primary">
                                <h4 class="modal-title" id="Part_wall_modelLabel__@{{ fIndex }}"> Partisan Wall - @{{ profile.FloorName }}</h4>
