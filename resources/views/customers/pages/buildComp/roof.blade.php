    ...
    <tbody>
        <tr ng-repeat="(fIndex,profile) in Profiles">
            ...
            <td  width="20%">
                ...
                <select class="form-select" ng-model="profile.DeliveryType">
            ...
            <td class="text-center">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#roof_wall_model____@{{ fIndex }}"><i class="fa fa-pencil"></i></button>
                <div id="roof_wall_model____@{{ fIndex }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="roof_wall_model__Label__@{{ fIndex }}" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header modal-colored-header bg-primary">
                                <h4 class="modal-title text-center" id="roof_wall_model__Label__@{{ fIndex }}"> <i class="mdi mdi-home-roof" style="font-size: 25px"></i> Roof - @{{ profile.FloorName }}</h4>
