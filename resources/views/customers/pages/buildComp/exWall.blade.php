...
<tbody>
    <tr ng-repeat="(fIndex,profile) in Profiles">
        ...
        <td class="text-center">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#primary-header-modal__@{{ fIndex }}"><i class="fa fa-pencil"></i></button>
            <div id="primary-header-modal__@{{ fIndex }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel__@{{ fIndex }}" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header modal-colored-header bg-primary">
                            <h4 class="modal-title" id="primary-header-modalLabel__@{{ fIndex }}">External Wall - @{{ profile.FloorName }}</h4>
