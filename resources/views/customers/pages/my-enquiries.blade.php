                ...
                <div class="card">
                    <div  class="card-header ">
                        <div class="btn-group shadow">
                            <a  href="{{ route('customers-create-enquiries') }}" class="btn btn-primary"><i class="mdi mdi-briefcase-plus"></i>  Create</a>
                            <button type="button" data-bs-toggle="modal" data-bs-target="#right-modal" title="Click to Filter" class="btn btn-light border"><i class="mdi mdi-filter-menu"></i> </button>
                        </div>
                    </div>
                    <div class="card-body">
