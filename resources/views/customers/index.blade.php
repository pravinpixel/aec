                            ...
                            <div class="col-xl-3 col-lg-4">
                                <div class="card shadow tilebox-one">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-uppercase text-primary mt-0">Total Projects</h6>
                                        <h2 class="my-2" >109</h2>
                                    </div> <!-- end card-body-->
                                </div>
                                <!--end card-->
                                ...
                                <div class="card tilebox-one">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-uppercase text-success mt-0">Completed Projects</h6>
                                        <h2 class="my-2"  >84</h2>
                                    </div> <!-- end card-body-->
                                </div>
                                <!--end card-->
                                ...
                                <div class="card tilebox-one">
                                    <div class="card-body">
                                        <i class='uil uil-window-restore float-end'></i>
                                        <h6 class="text-uppercase text-warning mt-0">Project in Progress</h6>
                                        <h2 class="my-2"  >25</h2>
                                    </div> <!-- end card-body-->
                                </div>
                                <!--end card-->
                            ...
                            <div class="col-xl-9 col-lg-8">
                                <div class="card card-h-100">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title mb-3">Projects Overview</h4>
