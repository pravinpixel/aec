<div>
    ...
    <div class="card-body px-3 pt-3">
        ...
        @endif
        <x-accordion title="Project Infomation" path="false" open="true" argument="{{ getModuleMenuMessagesCount('project', $project['id'], __('app.Project_Information'), 'count') }}">
            <div class="row m-0 "> 
                <div class="col-md-6">
                    ...
                    @if (count($project['sharepoint']['folders']) > 0)
                        <ul class="list-group py-1 px-2">
                            @foreach ($project['sharepoint']['folders'] as $folder)
                                <li class="list-group-item"><i class="mdi mdi-folder-open me-1"></i>{{ $folder['name'] }}</li>
                            @endforeach
                        </ul>
                    @endif  
                </div>
                ...
                <div class="card-body">
                    <div class="col-md-12 col-md-12 px-2 border-bottom"> 
                        <div class="row m-0 align-items-center shadow">
                            <div class="col-4 p-0">
                                <label class="col-form-label fw-bold">Should the project be linked to a customer ? </label>
                            </div> 
                            <div class="col pe-0">
        ...
        <x-accordion title="Invoice Plan" path="false" open="false" argument='null'>
            <div class="row my-2 mx-3 align-items-center">
                <div class="col-6">
                    <div class="row m-0 align-items-center">
                        ...
                        <div class="col pe-0"> 
                            <div class="form-control form-control-sm  border-0  ng-binding">{{ $project['invoice_plan']['project_cost'] }}</div>  
                        </div> 
                    </div>
                    <div class="row m-0 align-items-center">
                        <div class="col-6  p-0">
                        ...
                        <div class="col pe-0"> 
                            <div class="form-control form-control-sm  border-0  ng-binding"> {{ $project['start_date'] }}</div>  
                        </div> 
                    </div>
                </div>
                <div class="col-6">
                     <div class="row m-0 align-items-center">
                        ...
                        <div class="col pe-0"> 
                            <div class="form-control form-control-sm  border-0">{{ $project['invoice_plan']['no_of_invoice'] }}</div>  
                        </div> 
                    </div>
                    <div class="row m-0 align-items-center">
                        <div class="col-6  p-0">
                        ...
                        <div class="col pe-0"> 
                            <div class="form-control form-control-sm  border-0  ng-binding"> {{ $project['delivery_date'] }}</div>  
                        </div> 
                    </div>
                </div>
            </div>
            <table class="table custom m-0 custom table-striped table-bordered">
                ...
                <tbody> 
                    @if (count($project['invoice_plan']['invoice_data']->invoices) > 0)
                                ...
                                <div class="card-content">
                                    <table class="m-0 table custom">
                                        <thead>
                                            ...
                                            <tr>
                                                <td colspan="3"></td>
                                                <td class="text-center"><span class="bg-warning fw-bold rounded px-1">{{ $to_do->project_start_date }}</span></td>
                                                <td class="text-center"><span class="bg-warning fw-bold rounded px-1">{{ $to_do->project_end_date }}</span></td>
                                            </tr>
                                        </thead>
