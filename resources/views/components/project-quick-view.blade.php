<div>
    @if ($table_status == 1)
        <div class="card-header sticky-top px-3 d-flex justify-content-between align-items-center">
            <h3 class="card-title h4"><span class="text-primary">{{ str_replace('_',' ', $project['status']) }} PROJECT</span></h3>
                    ...
                    <div class="row m-0 ">
                        ...
                        <div class="col-md-6">
                            <div class="row m-0 align-items-center">
                                ...
                                <div class="col pe-0">
                                    <div class="form-control form-control-sm  border-0 ">{{ SetDateFormat($project['start_date']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        @if ($project['invoice_plan']['no_of_invoice'] > 0)
                            @foreach ($project['invoice_plan']['invoice_data']->invoices as $key => $invoice)
                                <tr>
                                    ...
                                    <td class="text-center">{{ SetDateFormat($invoice->invoice_date) }}</td>
