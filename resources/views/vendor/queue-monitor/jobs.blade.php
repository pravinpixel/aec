...
@section('admin-content')
    ...
    <div class="content-page">
        <div class="content" ng-controller="SalesController">
            ...
            <div class="container-fluid"> 
                <h4 class="text-2xl mb-4 text-blue-900 font-bold">
                    @lang('Queue Monitor')
                </h4>
                ...
                <div class="col-lg-10 mx-auto card">
                    ...
                    <div class="card-body">
                        <form action="" method="get">
                            <div class="row w-100  align-items-center my-2 -mx-2">
                                <div class="col">
                                    <label for="filter_show" class="block mb-1 text-xs  font-semibold text-gray-600">
                                        @lang('Show jobs')
                                    </label>
                                ...
                                <div class="col">
                                    <label for="filter_queues" class="block mb-1 text-xs  font-semibold text-gray-600">
                                        @lang('Queues')
                                    </label>
                                ...
                                <td colspan="100" class="px-6 py-4 text-gray-700 font-sm border-t-2 border-gray-200">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <div>
                                            ...
                                            <a class="btn btn-sm @if(!$jobs->onFirstPage()) bg-gray-200 hover:bg-gray-300 cursor-pointer @else text-gray-600 bg-gray-100 cursor-not-allowed @endif rounded"
                                               @if(!$jobs->onFirstPage()) href="{{ $jobs->previousPageUrl() }}" @endif>
                                                @lang('Previous')
                                            </a>
            
                                            <a class="btn btn-sm @if($jobs->hasMorePages()) bg-gray-200 hover:bg-gray-300 cursor-pointer @else text-gray-600 bg-gray-100 cursor-not-allowed @endif rounded"
