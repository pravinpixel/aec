<section>
    <div class="text-center py-3">
        <div class="btn-group p-2 px-3 col-4  border border-primary rounded-pill border shadow mx-auto align-items-center">
            ...
            <div class="ms-auto">
                <input type="checkbox" id="share_point_status"  wire:model="share_point_status"  data-switch="primary"/>
                    ...
                    @foreach ($sharePointAccess as $file_index => $row)
                        <tr>
                            ...
                            <td class="text-center">
                                <div>
                                    <input type="checkbox" value="{{ $row->id }}" id="switch__{{$file_index}}" wire:model.lazy="share_folder_name.{{ $row->id }}" {{ $share_point_status === 0 ? 'disabled' : '' }} data-switch="primary"/>
