<div class="cardx">                            
    <div class="text-center py-3">
        <div class="btn-group p-2 px-3 col-4  border border-primary rounded-pill border shadow mx-auto align-items-center">
            ...
            <div class="ms-auto">
                <input type="checkbox" id="switch__@{{ index }}"  ng-change="sharePoint_status(share_point_status)" ng-checked="share_point_status == 1" ng-model="share_point_status" data-switch="success"/>
                    ...
                    <tr ng-repeat="(index,employee) in sharePointAccess_module">
                        ...
                        <td class="text-center">
                            <div>
                                ...
                                ng-change="employee_status(share_point_status,employee.status,employee.data_name)" ng-model="employee.status" data-switch="success"/>
                                <label for="switch__@{{index}}" data-on-label="On"  data-off-label="Off"></label>
                            </div> 
