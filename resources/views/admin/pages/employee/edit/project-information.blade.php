...
<div class="row">
                    ...
                    <div class="row m-0">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-md-1">
                                        <div class="mb-3"> 
                                            <img src="{{ asset('/public/
                                            /employees/image/') }}/@{{EmpData.image}}" width="60px">
                                        </div>
    ...
    <div class="text-end mt-3">
        ...
        <button  ng-click="update(modalstate, id);"  class="btn btn-primary font-weight-bold px-3"> Next </button>
    </div>
</form> 