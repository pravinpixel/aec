                        ...
                        <div class="card-body p-4">
                            <form class="needs-validations"  novalidate name="frm"  >
                                ...
                                <div class="row m-0">
                                        ...
                                        <div class="row m-0">
                                            <div class="col">
                                                <div class="mb-3">                                             
                                                    ...
                                                    <input ng-disabled="true" type="text" ng-value="myWelcome" value="/@{$data[employee_id]}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="epm_number" id="validationCustom02" ng-model="FormData.epm_number" ng-minlength="10" placeholder="Type Here..."  ng-required="true">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                ...
                                <div class="text-end mt-3">
                                    ...
                                    <button ng-disabled="frm.$invalid" ng-click="submit(modalstate, id);" class="btn btn-primary font-weight-bold px-3"><i class="fa fa-check-circle "></i> Send </button>
                                </div>
                            </form>
                        </div> 
                    </div>
