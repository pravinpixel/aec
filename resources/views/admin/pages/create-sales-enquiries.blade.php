                                ...
                                <div class="row m-0">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" name="enquiry_date"   ng-model="module.enquiry_date" placeholder="Type Here..." ng-required="true">
                                            <span class="help-inline" ng-show="frm.enquiry_date.$invalid &amp;&amp; frm.enquiry_date.$touched"><small class="text-danger">field is required</small></span>
                                            <span class="help-inline" ng-show="frm.enquiry_date.$valid &amp;&amp; frm.enquiry_date.$touched"><small class="text-success">Looks good!</small></span>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
