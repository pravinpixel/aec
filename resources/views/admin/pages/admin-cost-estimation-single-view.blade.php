                                ...
                                <table class="cost-estimate-table table table-bordered border"  id="costEstimateTable">
                                    ...
                                    <tbody id="add_estimate">
                                            ...
                                            <tr>
                                                ...
                                                <td  ><input  type="number"  name="addmore[0][complexity]"  onkeypress="return isNumber(event)" step="0.1" min="1" max="2" data-complexity_id="0" id="complexity__0" value="1" class="my-control complexity_val"></td>
                                                <td  ><input  type="number"  name="addmore[0][detail_price]"  onkeypress="return isNumber(event)" min="0" data-detail-price_id="0" id="detail_price__0" value="0" class="my-control detail_price"></td>
                                                <td  ><input  type="number"  name="addmore[0][detail_sum]"  onkeypress="return isNumber(event)" min="0" data-detail-sum_id="0" id="detail_sum__0" value="0" class="my-control detail_sum"></td>
                                                <td  ><input  type="number"  name="addmore[0][statistic_price]"  onkeypress="return isNumber(event)" min="0" data-statistic-price_id="0" id="statistic_price__0" value="0" class="my-control statistic_price"></td>
                                                <td  ><input  type="number"  name="addmore[0][statistic_sum]"  onkeypress="return isNumber(event)" min="0" data-statistic-sum_id="0" id="statistic_sum__0" value="0" class="my-control statistic_sum"></td>
                                                <td  ><input  type="number"  name="addmore[0][cad_cam_price]"  onkeypress="return isNumber(event)" min="0" data-cad_cam-price_id="0" id="cad_cam_price__0" value="0" class="my-control cad_cam_price"></td>
                                                <td  ><input  type="number"  name="addmore[0][cad_cam_sum]"  onkeypress="return isNumber(event)" min="0" data-cad_cam-sum_id="0" id="cad_cam_sum__0" value="0" class="my-control cad_cam_sum"></td>
                                                <td  ><input  type="number"  name="addmore[0][logistic_price]"  onkeypress="return isNumber(event)" min="0" data-logistic-price_id="0" id="logistic_price__0" value="0" class="my-control logistic_price"></td>
                                                <td  ><input  type="number"  name="addmore[0][logistic_sum]"  onkeypress="return isNumber(event)" min="0" data-logistic-sum_id="0" id="logistic_sum__0" value="0" class="my-control logistic_sum"></td>
                                                <td  ><input  type="number"  name="addmore[0][total_price]"  onkeypress="return isNumber(event)" min="0" data-total-price_id="0" id="total_price__0" value="0" class="my-control total_price" readonly ></td>
                                                <td  ><input  type="number"  name="addmore[0][total_sum]"  onkeypress="return isNumber(event)" min="0" data-total-sum_id="0" id="total_sum__0" value="0" class="my-control total_sum" readonly > </td>
