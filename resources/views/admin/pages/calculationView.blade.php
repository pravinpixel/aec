...
<div class="card ">
    <div class="card-header">
        <div class="row m-0">
            <div class="col-md-6">
                <label for="" class="mb-1">Select type one</label>
            ...
            <div class="col-md-6">
                <label for="" class="mb-1">Select type two</label>
    ...
    <div class="card-body">
        <table class="table table-hover table-striped table-s" id="table11" >
            <thead>
                <tr>
                    ...
                    @foreach($data['type'] as $type)
                            ...
                            <tr class="needs-validations " name="cal_frm" >
                               ...
                               @if($arr[$buildingComponent->id][$type->id]->id ??'')
                                <td style="padding: 0 !important;">
                                    <a class="delete delete_data btn btn-outline-danger btn-sm cal_delete" name="col_delete<?php echo $i ?>"  data-col_delete_id="{{ $arr[$buildingComponent->id][$type->id]->id ??''}}" ><i class="fa fa-trash"></i></a>
                                </td>
                                @endif
                                <!-- <td style="padding: 0 !important">
