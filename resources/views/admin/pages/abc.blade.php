                        ...
                        <div class="row m-0 mt-3 table-rer" >
                            <table class="table table-bordered border" id="costEstimateTable">
                                ...
                                <tr>
                                        ...
                                        <td >
                                            <select class="form-control select2 validateArray addmore_component" name="addmore[0][component]" id="addmore_component[0]" data-toggle="select2">
                                                <option value="">Select</option>
                                                <optgroup label="Layer Types">
                                        ...
                                        <td >
                                            <select class="form-control select2 addmore_type"   required name="addmore[0][type]" data-toggle="select2">
                                                <option value="">Select</option>
                                                <optgroup label="Layer Types">
...
@push('custom-scripts')
    ...
    <script>
        $( document ).ready(function() {
            ...
            $( ".addmore_type" ).change(function() {
               var component = $('.addmore_component').val();
                var type = $('.addmore_type').val();
            alert( component );
            alert( type );
