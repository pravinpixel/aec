            ...
            <tbody>
                <tr ng-repeat="(index,layerType) in layerType_module_get">
                    ...
                    <td class="text-center" >
                        <div class="btn-group">
                            <button class="shadow btn btn-sm mx-2 btn-outline-primary l rounded-pill" ng-click="toggleLayerType('edit', layerType.id)"><i class="fa fa-edit"></i></button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-@{{form_color}}" id="btn-save" ng-click="save_layerType(modalstate, id); $event.stopPropagation();" ng-disabled="module_layerType.$invalid">Submit</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div> 