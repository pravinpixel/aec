            ...
            <tbody>
                <tr ng-repeat="(index,output) in output_module_get">
                    ...
                    <td class="text-center" >
                        <div class="btn-group">
                            <button class="shadow btn btn-sm mx-2 btn-outline-primary l rounded-pill" ng-click="toggleOutput('edit', output.id)"><i class="fa fa-edit"></i></button>
            ...
            <div class="modal-body">
                <form name="OutputModule" class="form-horizontal" novalidate="">
                    <div class="form-group error mb-2">
                        <label for="inputEmail3" class="col-sm-12 text-dark control-label mb-2">Output Name</label>
                        <div class="col-sm-12">
