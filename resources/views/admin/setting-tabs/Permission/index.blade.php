										...
										<td class="text-center">
											<div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input ng-model="permissionForm.enquiry_index" ng-checked="view_checkbox" type="checkbox" class="form-check-input view_checkbox " value="1" id="enquiry_index" name="enquiry_index" checked />
													@else
													<input ng-model="permissionForm.enquiry_index" ng-checked="view_checkbox" type="checkbox" class="form-check-input view_checkbox" value="1" id="enquiry_index" name="enquiry_index" />
													@endif
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.enquiry_add" value="1" id="enquiry_add" name="enquiry_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.enquiry_add"value="1" id="enquiry_add" name="enquiry_add">
													@endif
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input edit_checkbox" ng-checked="edit_checkbox" ng-model="permissionForm.enquiry_edit" value="1" id="enquiry_edit" name="enquiry_edit" checked />
													@else
													<input type="checkbox" class="form-check-input edit_checkbox" ng-checked="edit_checkbox" ng-model="permissionForm.enquiry_edit" value="1" id="enquiry_edit" name="enquiry_edit" />
													@endif
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input delete_checkbox" ng-checked="delete_checkbox" ng-model="permissionForm.enquiry_delete"value="1" id="enquiry_delete" name="enquiry_delete" checked />
													@else
													<input type="checkbox"  class="form-check-input delete_checkbox" ng-checked="delete_checkbox" ng-model="permissionForm.enquiry_delete" value="1" id="enquiry_delete" name="enquiry_delete" />
													@endif
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.project_summary_add" value="1" id="project_summary_add" name="project_summary_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.project_summary_add"value="1" id="project_summary_add" name="project_summary_add">
													@endif
													<label for="enquiry-add"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input ng-model="permissionForm.technical_estimate_index" ng-checked="view_checkbox" type="checkbox" class="form-check-input view_checkbox" value="1" id="technical_estimate_index" name="technical_estimate_index" checked />
													@else
													<input ng-model="permissionForm.technical_estimate_index" ng-checked="view_checkbox" type="checkbox" class="form-check-input view_checkbox" value="1" id="technical_estimate_index" name="technical_estimate_index" />
													@endif
													<label for="eproject_summar_index"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.technical_estimate_add" value="1" id="technical_estimate_add" name="technical_estimate_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.technical_estimate_add"value="1" id="technical_estimate_add" name="technical_estimate_add">
													@endif
													<label for="enquiry-add"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input edit_checkbox" ng-checked="edit_checkbox" ng-model="permissionForm.technical_estimate_edit" value="1" id="technical_estimate_edit" name="technical_estimate_edit" checked />
													@else
													<input type="checkbox" class="form-check-input edit_checkbox" ng-checked="edit_checkbox" ng-model="permissionForm.technical_estimate_edit" value="1" id="technical_estimate_edit" name="technical_estimate_edit" />
													@endif
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input delete_checkbox" ng-checked="delete_checkbox"  ng-model="permissionForm.technical_estimate_delete"value="1" id="technical_estimate_delete" name="technical_estimate_delete" checked />
													@else
													<input type="checkbox"  class="form-check-input delete_checkbox" ng-checked="delete_checkbox" ng-model="permissionForm.technical_estimate_delete" value="1" id="technical_estimate_delete" name="technical_estimate_delete" />
													@endif
										...
										<td class="text-center">
											<div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input ng-model="permissionForm.cost_estimate_index" type="checkbox" ng-checked="view_checkbox" class="form-check-input view_checkbox " value="1" id="cost_estimate_index" name="cost_estimate_index" checked />
													@else
													<input ng-model="permissionForm.cost_estimate_index" type="checkbox" ng-checked="view_checkbox" class="form-check-input view_checkbox" value="1" id="cost_estimate_index" name="cost_estimate_index" />
													@endif
													<label for="eproject_summar_index"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.cost_estimate_add" value="1" id="cost_estimate_add" name="cost_estimate_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.cost_estimate_add"value="1" id="cost_estimate_add" name="cost_estimate_add">
													@endif
													<label for="enquiry-add"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.proposal_sharing_add" value="1" id="proposal_sharing_add" name="proposal_sharing_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.proposal_sharing_add"value="1" id="proposal_sharing_add" name="proposal_sharing_add">
													@endif
													<label for="enquiry-add"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.customer_response_add" value="1" id="customer_response_add" name="customer_response_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.customer_response_add"value="1" id="customer_response_add" name="customer_response_add">
													@endif
													<label for="enquiry-add"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.employee_add" value="1" id="employee_add" name="employee_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.employee_add"value="1" id="employee_add" name="employee_add">
													@endif
													<label for="enquiry-add"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.project_add" value="1" id="project_add" name="project_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.project_add"value="1" id="project_add" name="project_add">
													@endif
													<label for="enquiry-add"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.task_add" value="1" id="task_add" name="task_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox"  ng-checked="add_checkbox" ng-model="permissionForm.task_add"value="1" id="task_add" name="task_add">
													@endif
													<label for="enquiry-add"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.contract_add" value="1" id="contract_add" name="contract_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.contract_add"value="1" id="contract_add" name="contract_add">
													@endif
													<label for="enquiry-add"></label>
												</div>
											</div>
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.supplier_detail_add" value="1" id="supplier_detail_add" name="supplier_detail_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.supplier_detail_add"value="1" id="supplier_detail_add" name="supplier_detail_add">
													@endif
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.customer_detail_add" value="1" id="customer_detail_add" name="customer_detail_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox"  ng-model="permissionForm.customer_detail_add"value="1" id="customer_detail_add" name="customer_detail_add">
													@endif
										...
										<td class="text-center">
											<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
												<div class="checkbox">
													...
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.project_schedule_add" value="1" id="project_schedule_add" name="project_schedule_add" checked>
													@else
													<input type="checkbox" class="form-check-input add_checkbox" ng-checked="add_checkbox" ng-model="permissionForm.project_schedule_add"value="1" id="project_schedule_add" name="project_schedule_add">
													@endif
