...
<div class="card">
    <div class="card-header ">
        <div class="d-flex justify-content-between">
            ...
            <button class="btn btn-primary " ng-click="toggleRole('add', 0)">Create New Task</button>
        </div>
    </div>
    <div class="card-body">
                ...
                <tr ng-repeat="(index,taskList) in taskLists">
                    ...
                    <td>
                        <div>
                            ...
                            <label for="switch__@{{index}}" data-on-label="On" ng-click="checkItRole(index, taskList.is_activeata-off-label="Off"></label>
                        </div>
                    ...
                    <td>
                        <div class="btn-group">
                            <button class="shadow btn btn-sm me-2 btn-outline-primary l rounded-pill" ng-click="toggleRole('edit', taskList.id)"><i class="fa fa-edit"></i></button>
                            <button class="shadow btn btn-sm btn-outline-secondary rounded-pill  " ng-click="confirmRoleDelete(taskList.id)"><i class="fa fa-trash"></i></button>
                        </div>
                    </td>
                </tr>
            </tbody>
