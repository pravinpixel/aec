        ...
        <table  dt-options="vm.dtOptions" class="table custom table-striped table-bordered">
            ...
            <tbody>
                <tr ng-repeat="(index,deliveryLayer) in deliveryLayer_module_get track by deliveryLayer.id">
                    ...
                    <td>
                        <div>
                            <input type="checkbox" id="switch__@{{ index }}" ng-checked="deliveryLayer.is_active == 1" data-switch="success"/>
                    ...
                    <td  >
                        <div class="btn-group">
                            ...
                            <button class="shadow btn btn-sm btn-outline-danger rounded-pill  " ng-click="confirmDeliveryLayerDelete(deliveryLayer.id)"><i class="fa fa-trash"></i></button>
                        </div>
                    </td>
