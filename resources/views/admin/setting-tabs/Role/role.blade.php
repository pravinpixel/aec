        ...
        <table dt-options="vm.dtOptions" class="table m-0 custom table-centered table-striped table-bordered">
            ...
            <tbody>
                <tr ng-repeat="(index,m) in role_module_get track by m.id">
                    ...
                    <td width="50px">
                        <div>
                            <input type="checkbox" id="switch__@{{ index }}" ng-checked="m.status == 1" data-switch="success"/>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <button class="shadow btn btn-sm btn-outline-danger rounded-pill  " ng-click="confirmRoleDelete(m.id)"><i class="fa fa-trash"></i></button>
                        </div>
                    </td>
