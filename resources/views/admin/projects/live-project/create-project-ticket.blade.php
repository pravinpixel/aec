                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>Date of Change Request</b></td>
                                                <td><input type="date" get-to-do-lists ng-value="ticket.change_date | date: 'yyyy-MM-dd'" ng-model="ticket.change_date" id="" class=" border-0 form-control form-control-sm"></td>
                                        </tr> 
                                    </tbody>
                                </table>
                                <div class="row m-0">
