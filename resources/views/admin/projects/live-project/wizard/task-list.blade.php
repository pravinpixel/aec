    ...
    <table class="m-0 table table-hover table-bordered custom" ng-repeat="(index,check_list) in check_list_items">
        ...
        <tbody class="border"  ng-repeat="(index_2 , checkListData) in check_list.data" >
            ...
            <tr ng-repeat="(index_3 , taskListData) in checkListData.data">
                ...
                <td> 
                    <input type="hidden" get-to-do-lists ng-value="taskListData.start_date | date: 'yyyy-MM-dd'" ng-model="taskListData.start_date" id="" class=" border-0 form-control form-control-sm">
                    
                    <label get-to-do-lists ng-value="taskListData.start_date | date: 'yyyy-MM-dd'" id="" class=" border-0 form-control form-control-sm" ng-readonly="">@{{taskListData.start_date | date: 'yyyy-MM-dd'}}</label></td>
                <td> 
                    <input type="hidden" get-to-do-lists ng-value="taskListData.end_date | date: 'yyyy-MM-dd'" ng-model="taskListData.end_date" id="" class=" border-0 form-control form-control-sm">
                    <label get-to-do-lists ng-value="taskListData.end_date | date: 'yyyy-MM-dd'" id="" class=" border-0 form-control form-control-sm" ng-readonly="">@{{taskListData.end_date | date: 'yyyy-MM-dd'}}</label></td>
                ...
                <td><input type="date" get-to-do-lists ng-value="taskListData.delivery_date | date: 'yyyy-MM-dd'" ng-model="taskListData.delivery_date" id="" class=" border-0 form-control form-control-sm"></td>
            </tr> 
