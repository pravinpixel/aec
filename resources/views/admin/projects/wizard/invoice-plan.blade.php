            ...
            <table class="table custom m-0 custom table-bordered">
                ...
                <tbody calculate-amount>
                    <tr ng-repeat="invoicePlan in invoicePlans.invoices track by $index">
                        ...
                        <td class="text-center"><input ng-disabled="invoicePlans.invoices.length == $index + 1" ng-required="true"
                                type="text" select-on-click onkeypress="return isNumber(event)" name="percentage"
