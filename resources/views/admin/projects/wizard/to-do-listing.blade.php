...
<div class="cardx">
    <div class="card-body">
        <fieldset class="accordion-item">
            <div class="accordion-header custom m-0 position-relative" id="Cabin_projects_header">
                <div class="accordion-button " data-bs-toggle="collapse" data-bs-target="#Cabin_projects" aria-expanded="true" aria-controls="Cabin_projects">
                    <span class="position-relative btn py-0">CABIN PROJECTS </span> 
                </div>
                <div class="icon m-0 position-absolute rounded-pills" style="right: 10px;top:30%; z-index:111 !important">
                    <i data-bs-toggle="collapse" 
                        href="#Cabin_projects" 
                        aria-expanded="false" 
                        aria-controls="Cabin_projects" 
                        class="accordion-button custom-accordion-button bg-primary text-white toggle-btn ">
                    </i>
                </div>
            </div>
            <div id="Cabin_projects" class="accordion-collapse collapse show" aria-labelledby="Cabin_projects_header" >
