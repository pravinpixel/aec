<a class="btn dropdown-item"  ng-click="showCommentsToggle()" > View / Add comments</u></a>
            ...
            <div class="card w-100 h-100">
                ...
                <div class="card-footer bg-light">
                    <form id="Inbox__commentsForm"  class="d-flex align-items-center">
                        ...
                        <button class="btn btn-primary rounded-pill" type="button" ng-click="sendInboxComments('Admin')"><i class="fa fa-send"></i></button>
                    </form> 
                </div>
            </div>  
        </div><!-- /.modal-content -->
