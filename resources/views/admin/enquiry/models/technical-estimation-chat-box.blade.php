<div id="tech-viewConversations-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content h-100 d-flex justify-content-center bg-light align-items-center" >
            <div class="card w-100 h-100">
                ...
                <div class="card-footer bg-light">
                    <form id="Inbox__commentsForm" ng-submit="sendTechInboxComments('Admin', 'techical_estimation' , technical_docType_id)" class="d-flex align-items-center">
