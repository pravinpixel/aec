            ...
            $scope.printTechnicalEstimate = () => {
                $http.get(`${API_URL}technical-estimate/get-history/${$scope.enquiry_id}`).then((res) => {
                    ...
                    a.document.write(`
                        ...
                        <style>.table {border:0 !important; box-shadow: none !important} .thead , button , .fa {display:none !important} .tbody { padding : 0 !important} .btn{display:none !important} input{pointer-events:none } .custom-border-left{border-left:1px solid #000!important}.custom-border-bottom{border-bottom:1px solid #000!important}.custom-td{border-right:1px solid #000!important;border-top:1px solid #000!important;border-left:none!important;border-bottom:none!important;width:100px!important;min-width:100px!important;max-width:100px!important;display:flex;justify-content:center;align-items:center;flex-direction:column}.custom-td *{font-size:12px!important}.custom-row{display:inline-flex!important}.custom-td input{padding:0!important;height:100%;width:100%}.custom-td input,.custom-td select{color:#000!important}</style>
                    `);
                    let enquiryData = `
            ...
            $scope.printCostEstimate = (type) => {
                ...
                .then((res) => {
                    ...
                    a.document.write(`
                        ...
                        <link rel="stylesheet" href="{{ asset('public/custom/css/app.css') }}"> 
                        <link rel="stylesheet" href="{{ asset('public/custom/css/table.css') }}">
                        <style> input,select{pointer-events:none},.card {border:0 !important; box-shadow: none !important} .card-header , button , .fa {display:none !important} .card-body { padding : 0 !important}  .custom-border-left{border-left:1px solid #000!important}.custom-border-bottom{border-bottom:1px solid #000!important}.custom-td{border-right:1px solid #000!important;border-top:1px solid #000!important;border-left:none!important;border-bottom:none!important;width:100px!important;min-width:100px!important;max-width:100px!important;display:flex;justify-content:center;align-items:center;flex-direction:column}.custom-td *{font-size:12px!important}.custom-row{display:inline-flex!important}.custom-td input{padding:0!important;height:100%;width:100%}.custom-td input,.custom-td select{color:#000!important}</style>
                    `);
                    let enquiryData = `
                        <div class="card-body pt-0 p-0">
                            <table class="table custom shadow-none border m-0 table-bordered ">
                                    ...
                                    if(scope.index == componentIndex) {
                                        Component.Dynamics.forEach( (Dynamic, dynamicIndex) => {
                                            if(Estimates.Components[componentIndex].Dynamics[dynamicIndex].name == 'Details') {
                                                ...
                                                Estimates.Components[componentIndex].Dynamics[dynamicIndex].Sum = Number(response.detail_sum) || 0;
                                                ...
                                                Estimates.Components[componentIndex].Dynamics[dynamicIndex].Sum = Number(response.statistic_sum) || 0;
                                                ...
                                                Estimates.Components[componentIndex].Dynamics[dynamicIndex].Sum = Number(response.cad_cam_sum) || 0;
                                                ...
                                                Estimates.Components[componentIndex].Dynamics[dynamicIndex].Sum = Number(response.logistic_sum) || 0 ;
                                            } else {
