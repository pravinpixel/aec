                            ...
                            <table class="table border table-bordered">
                                ...
                                <tbody psi-sortable="" ng-model="buliding.building_component_number">
                                    <tr ng-repeat="(secindex,est) in buliding.building_component_number track by $index">
                                        ...
                                        <td class="col"  style="padding:0 !important" >
                                            <input type="text" onkeypress="return isNumber(event)" get-total-components="[index , secindex]" class="form-control form-control-sm rounded-0 border-0" ng-model="est.sqfeet" ng-value="est.sqfeet">
                                        </td>
