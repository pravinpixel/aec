    ...
    <div>
        <div class="card shadow-none p-0" class="accordion accordion-flush" id="accordionFlushExample">
            <div class="p-2 mx-auto col-md-6" ng-hide="proposal.length">
                ...
                <div class="d-flex">
                    <select class="form-select me-2" ng-disabled="proposal.length"
                        ng-model="documentary.documentary_title" name="documentary_title" ng-required="true">
                                ...
                                <td style="padding: 0 !important">
                                    <table class="table custom table-bordered m-0">
                                        <tbody class="panel">
                                                    ...
                                                    <div class="d-flex text-center">
                                                        <div class="me-2" ng-show="P.get_versions.length">
                                                            <i data-bs-toggle="collapse"
                                                                href="#togggleTable@{{ key + 1 }}"
                                                                aria-expanded="true"
                                                                aria-controls="togggleTable@{{ key + 1 }}"
                                                                class="accordion-button custom-accordion-button collapsed bg-primary text-white toggle-btn m-0"></i>
                                                        </div>
                                                        <div class="me-2" ng-show="!P.get_versions.length"
                                                            style="visibility: hidden">
                                                            <i
                                                                class="accordion-button custom-accordion-button collapsed bg-white text-white toggle-btn m-0"></i>
                                                        </div>
                                                        <div class="text-center">@{{ key + 1 }}</div>
                                                    </div>
                                                </td>
                                                <td style="width: 10% !important" class="text-center">
                                                    <button type="button" class="btn-quick-view" ng-if="P.id"
                                            ...
                                            <tr id="togggleTable@{{ key + 1 }}" class="collapse"
                                                    ...
                                                    <table class="table custom table-bordered table-hover m-0">
                                                        <tbody>
                                                            <tr ng-repeat="(key2,V) in P.get_versions">
                                                                ...
                                                                <td style="width: 16% !important" class="text-center">
                                                                    <small
                                                                        ng-if="V.mail_send_date">@{{ V.mail_send_date | date: "MM/dd/yyyy 'at' h:mma" }}</small>
                                                                    <small ng-if="V.mail_send_date == null"> Not Yet
                                                                        Sent!</small>
                                                                </td>
