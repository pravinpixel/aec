                ...
                <div class="card-body" ng-controller="customerDetailController"> 
                    <form class="form-horizontal row m-0" id="customerDetailForm" method="post" action="{{ route('admin.customer.update', $customer->id) }}">
                        ...
                        <div class="my-2 col-md-6">
                            ...
                            <input class="form-control" type="text" name="first_name" value="{{ $customer->first_name ?? old('first_name') }}" id="first_name" required placeholder="Enter firstname">
                        ...
                        <div class="my-2 col-md-6">
                            ...
                            <input class="form-control" type="text" name="last_name" value="{{ $customer->last_name ?? old('last_name') }}" id="last_name" required placeholder="Enter last_name">
                        ...
                        <div class="my-2 col-md-6">
                            ...
                            <input class="form-control" type="email" name="email" id="email" required placeholder="Enter email address" value="{{  $customer->email ?? old('email') }}">
                            @if($errors->has('email'))
                        ...
                        <div class="my-2 col-md-6">
                            ...
                            <input type="text"  name="company_name" id="validationCustom01" class="form-control"  value="{{ $customer->company_name ?? old('company_name') }}" placeholder="Type Here..."  ng-required="true" list="companyList" ng-change="getCompany(company_name)" ng-model="company_name" />
                        ...
                        <div class="my-2 col-md-6">
                            ...
                            <input class="form-control" type="text" name="organization_no" value="{{ $customer->organization_no ?? old('organization_no') }}" id="organization_no" required placeholder="Enter organization number">
                        ...
                        <div class="my-2 col-md-6">
                            ...
                            <input class="form-control" type="text" name="phone_no" onkeypress="return isNumber(event)" id="phone_no" value="{{ $customer->phone_no ?? old('phone_no')  }}"  placeholder="Enter phone no">
                        ...
                        <div class="my-2 col-md-6">
                            ...
                            <input class="form-control" type="text" name="mobile_no" id="mobile_no" onkeypress="return isNumber(event)" value="{{ $customer->mobile_no   ?? old('mobile_no') }}"  required placeholder="Enter mobile no">
                        ...
                        <div class="my-2 col-md-6">
                            ...
                            <input class="form-control" type="text" name="fax" id="fax" value="{{ $customer->fax ?? old('fax') }}"   placeholder="Enter fax">
                            @if($errors->has('fax'))
                        ...
                        <div class="my-2 col-md-6">
                            ...
                            <input class="form-control" type="email" name="invoice_email" value="{{ $customer->invoice_email  ?? old('invoice_email') }}"  id="invoice_email"  placeholder="Enter invoice email address">
                        </div> 

                        <div class="my-2 col-md-6">
                            <label for="website" class="form-label text-secondary">Website</label>
                            <input class="form-control" type="text" name="website" id="website" value="{{ $customer->website   ?? old('website')}}"  placeholder="Enter wesite url">
