										...
										<div class="col-lg-12">
											<div class="card widget-flat">
												<div class="card-body">
													...
													<div class="text-success me-2"><i class="mdi mdi-arrow-up-bold fa-2x"></i>
														<span class="fa-2x">{{ $result['new_enquiries_last_month'] }}</span>
													</div>
										...
										<div class="col-lg-12">
											<div class="card widget-flat">
												<div class="card-body">
													...
													<div class="text-danger me-2"><i class="mdi mdi-arrow-down-bold fa-2x"></i>
														<span class="fa-2x">{{ $result['lost_enquiries_last_month'] }}</span>
													</div>
													<span class="text-nowrap">Since last month</span>
												</div> <!-- end card-body-->
											</div> <!-- end card-->
								...
								<div class="col-xl-9 col-lg-9">
									...
									<div class="card">
										<div class="card-body">
											...
											<div dir="ltr">
												<div id="revenue-chart" class="apex-charts mt-3" data-currentMonth="12,30,23,45"
													data-colors="#163269,#0acf97"></div>
											</div>
										</div> <!-- end card-body-->
									</div> <!-- end card-->
								</div> <!-- end col -->
