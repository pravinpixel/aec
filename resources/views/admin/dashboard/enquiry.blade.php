...
@section('admin-content')
    ...
    <div class="content-page" ng-app="Myapp">
        <div class="content" ng-controller="dashboardController">
                    ...
                    <div class="container-fluid">
                        ...
                        <div>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-6">
                                    <input type="text" id="_date" ng-model="enquiry_summary.date" class="form-control"
                                        name="daterange" />
                                </div>
                            </div>
                            <!-- end page title -->
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card widget-flat">
                                                <div class="card-body">
                                                    <div class="float-end">
                                                        <i
                                                            class="mdi mdi-comment-plus-outline widget-icon text-success"></i>
                                                    </div>
                                                    <h3 class="card-heading">New Enquiries</h3>
                                                    <div class="text-success me-2"><i
                                                            class="mdi mdi-arrow-up-bold fa-2x"></i>
                                                        <span
                                                            class="fa-2x">{{ $result['new_enquiries_last_month'] }}</span>
                                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card widget-flat">
                                                <div class="card-body">
                                                    <div class="float-end">
                                                        <i
                                                            class="mdi mdi-comment-remove-outline widget-icon text-danger"></i>
                                                    </div>
                                                    <h3 class="card-heading">Lost Enquiries</h3>
                                                    <div class="text-danger me-2"><i
                                                            class="mdi mdi-arrow-down-bold fa-2x"></i>
                                                        <span
                                                            class="fa-2x">{{ $result['lost_enquiries_last_month'] }}</span>
                                                    </div>
                                                    <span class="text-nowrap">Since last month</span>
                                                </div> <!-- end card-body-->
                                            </div> <!-- end card-->
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div dir="ltr">
                                                <div id="revenue-chart" class="apex-charts mt-3"
                                                    data-currentMonth="12,30,23,45" data-colors="#163269,#0acf97"></div>
                                            </div>
                                        </div> <!-- end card-body-->
                                    </div> <!-- end card-->
                                </div> <!-- end col -->
            ...
            @endif
            @if (userRoleName() == 'PROJECT_MANAGER')
                @include('admin.projects.dashboard')
            @endif
        </div> <!-- content -->
    </div>
@endsection
                ...
                $('input[name="daterange"]').daterangepicker({
                    ...
                    ranges: {
                        ...
                        'This Quarter': [moment().quarter(moment().quarter()).startOf('quarter'), moment()
                            .quarter(moment().quarter()).endOf('quarter')
                        ],
                        'This Year': [moment().startOf('year'), moment().endOf('year')]
                    }
                }, function(start, end, label) {
                    let url =
                        `${baseUrl}admin/dashboard?start_date=${moment(start).format('DD-MM-Y')}&end_date=${moment(end).format('DD-MM-Y')}`;
                    location.href = url;
                });
            });
        </script>
