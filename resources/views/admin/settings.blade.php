                    ...
                    <div class="col-sm-2 mb-2 mb-sm-0">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="v-pills-master-tab" data-bs-toggle="pill" href="#v-pills-master" role="tab" aria-controls="v-pills-master"
                                ...
                                <span class="d-none d-md-block" ng-click="masterGetData()">Master Estimation</span>
                            </a>
                            ...
                            <a class="nav-link" id="v-pills-output-tab" data-bs-toggle="pill" href="#v-pills-output" role="tab" aria-controls="v-pills-output"
                                aria-selected="false">
