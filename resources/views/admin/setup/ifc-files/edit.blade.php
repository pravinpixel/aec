            ...
            <form action="{{ route('setup.ifc-file-icon.update', $file->id) }}" method="POST" enctype="multipart/form-data"> 
                ...
                <div class="row mb-1">
                    <div class="col-md-6 mb-2">
                        ...
                        <input class="form-control form-control-sm" id="inputFileType" maxlength="5" type="text" placeholder="Example : png / jpg / svg" value="{{ $file->type }}" name="type"  >
                    </div>
                    <div class="col-md-6 mb-2">
                        <label class="small mb-1" for="inputFirstName">File Icon</label>
                        <input class="form-control form-control-sm" id="inputFirstName" accept="image/png, image/jpeg, image/jpg" type="file" placeholder="Enter your first name" name="icon"  >
