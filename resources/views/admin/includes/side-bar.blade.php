<div class="leftside-menu menuitem-active">
    ...
    <!-- LOGO -->
    <a href="{{ route('admin-dashboard') }}" class="logo text-center logo-light shadow-lg"
        ...
        <span class="logo-sm font-weight-bold ">
            ...
            <img src="{{ asset('public/assets/images/logo_sm.png') }}" alt="AEC Prefab" width="20px"
                style="filter: drop-shadow(2px 4px 6px #555555);">
        </span>
    </a>
    ...
    <a href="{{ route('admin-dashboard') }}" class="logo text-center logo-dark" style="background:gray !important">
        <span class="logo-lg font-weight-bold">
            <span class="page-title text-danger">
                {{-- <b>AEC</b> <span class="text-white">Prefab</span> --}}
                <img src="{{ asset('public/assets/images/logo_customer.png') }}" alt="AEC Prefab" width="100px"
                    style="filter: drop-shadow(2px 4px 6px #555555);">
            </span>
        </span>
        <span class="logo-sm font-weight-bold ">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav pt-3">
            @if (userHasAccess('enquiry_dashboard') ||
                    ...
                    userHasAccess('employee_performance'))
            ...
            @if (userHasAccess('enquiry_index') || userHasAccess('contract_index') || userHasAccess('sale_index'))
                <li
                    class="side-nav-item {{ Route::is(['view-enquiry', 'admin.enquiry-create', 'admin-documentary-view', 'admin.documentaryEdit', 'admin.add-documentary']) ? 'menuitem-active' : '' }}">
                    <a data-bs-toggle="collapse" href="#Sales" aria-expanded="false" aria-controls="Sales"
                        class="side-nav-link">
                        <i class="fa fa-briefcase" aria-hidden="true"></i>
                        <span> Sales </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse {{ Route::is(['view-enquiry', 'admin.enquiry-create', 'admin-documentary-view', 'admin.documentaryEdit', 'admin.add-documentary']) ? 'show' : '' }}"
                        id="Sales">
                        <ul class="side-nav-second-level">
                            @if (userHasAccess('enquiry_index'))
                                <li
                                    class="{{ Route::is(['view-enquiry', 'admin.enquiry-create']) ? 'menuitem-active' : '' }}">
                                    <a href="{{ route('admin.enquiry-list') }}">@lang('menu.enquiries')</a>
                                </li>
                            @endif
                            @if (userHasAccess('contract_index'))
                                <li
                                    class="{{ Route::is(['admin-documentary-view', 'admin.documentaryEdit', 'admin.add-documentary']) ? 'menuitem-active' : '' }}">
            ...
            @if (userRole()->slug == 'admin')
                <li
                    ...
                    <a data-bs-toggle="collapse" href="#Administration" aria-expanded="false"
                        aria-controls="Administration" class="side-nav-link">
                        <i class="fa fa-fingerprint" aria-hidden="true"></i>
                        <span>Administration</span>
                        <span class="menu-arrow"></span>
                    </a>
                    @if (userHasAccess('cost_estimate_calculation_index') ||
                            userHasAccess('gantt_chart_index') ||
                            userHasAccess('employee_index'))
                        <div class="collapse {{ Route::is(['admin-employee-control-view', 'admin.employee-add', 'admin.employeeEdit', 'create.employee', 'edit.employee']) ? 'show' : '' }}"
                            id="Administration">
                            <ul class="side-nav-second-level">
                                @if (userHasAccess('cost_estimate_calculation_index'))
                                    <li>
                            ...
                            @endif --}}
                                @if (userHasAccess('employee_index'))
                                    <li
                                        class="{{ Route::is(['admin-employee-control-view', 'admin.employee-add', 'admin.employeeEdit', 'create.employee', 'edit.employee']) ? 'menuitem-active' : '' }}">
