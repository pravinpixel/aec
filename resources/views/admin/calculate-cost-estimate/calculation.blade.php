                    ...
                    <div class="row">
                        <div ng-show="price_calculation == 'wood_engineering_estimation'">
                            <div class="table custom-responsive p-0">
                                <h5 class="text-center"> Wood Engineering Estimation </h5>
                                <button class="btn btn-success btn-sm" ng-click="createNewCalculation()">Create new calculation</button>
                            </div>
                        </div>
                    </div>
