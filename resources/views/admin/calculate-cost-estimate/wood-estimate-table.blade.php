                ...
                <div psi-sortable="" ng-model="C">
                    <div ng-repeat="(index, C) in CostEstimate.Components track by $index" class="custom-row custom-border-left custom-border-bottom bg-white" >
                        ...
                        <div class="custom-td custom-td-sm position-relative" >
                            <input type="number" ng-disabled="C.type_id == 5 && C.building_component_id == 6" name="C.DesignScope" get-cost-details-total="[index]" ng-model="C.DesignScope" ng-value="C.DesignScope" onkeypress="return isNumber(event)"
                                class="form-control  rounded-0 text-center form-control-sm">
                            <small class="position-absolute ms-4">%</small>
                        </div>
                        <div class="custom-td custom-td-sm"> <input type="number" ng-disabled="C.type_id == 5 && C.building_component_id == 6" onkeypress="return isNumber(event)" name="Complexity" ng-value="C.Complexity"
                                get-cost-details-total="[index]" ng-model="C.Complexity"
                                class="form-control  rounded-0 text-center form-control-sm">
                        </div>
                        <div class="custom-td custom-td-sm"> <input type="number" ng-disabled="C.type_id == 5 && C.building_component_id == 6" onkeypress="return isNumber(event)" name="Sqm"  ng-value="C.Sqm"
                        ...
                        <div class="custom-td custom-td-lg" ng-repeat="(thirdIndex, D) in C.Dynamics">
                            <div class="custom-row  text-center p-0">
                                <div class="p-0">
                                    <input type="number" ng-disabled="C.type_id == 5 && C.building_component_id == 6" onkeypress="return isNumber(event)" get-cost-details-total="[index]" ng-value="D.PriceM2"
                                        name="D.PriceM2" ng-model="D.PriceM2"
                                        class="form-control  rounded-0 text-center form-control-sm">
                                </div>
                                <div class="p-0">
                                    <input type="number" ng-disabled="C.type_id == 5 && C.building_component_id == 6" onkeypress="return isNumber(event)" ng-model="D.Sum" name="D.Sum" ng-value="D.Sum"
