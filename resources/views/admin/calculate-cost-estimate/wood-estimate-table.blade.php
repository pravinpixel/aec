                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <button class="dropdown-item" ng-click="callWoodTemplate(firstIndex)"><i class="fa fa-save me-1"></i>Save Template</button> 
                                <button class="dropdown-item" overwrite-template="{template:woodTemplate,type:'wood'}"><i class="fa fa-save me-1"></i>Overwrite Template</button> 
                                <button class="dropdown-item" delete-template="{template:woodTemplate,type:'wood'}"><i class="fa fa-trash me-1"></i>Delete Template</button> 
                            </div>
                        </div>
