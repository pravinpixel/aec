...
class ProposalController extends Controller
{
    ...
    {
        return $this->customerEnquiryRepo->getCustomerProPosalByID($id, $proposal_id);
    }
    ...
    public function download_proposal_version($id)
    {
        $contract      = ProposalVersions::find($id);
        $template_name = $contract->template_name;
        $aec_logo      = '<img width="150px" style="margin-left:217px" src="data:image/png;base64," alt="AEC PREFAB LOGO" />';
        $pdf           = Pdf::loadView('pdf.proposal', array('data' => $contract->documentary_content, 'template_name' => $template_name, 'aec_logo' => $aec_logo))->setPaper('A4');
        return $pdf->download('proposal-' . $contract->version . '.pdf');
    }
    public function editVersions(Request $request, $id, $proposal_id,  $Vid)
    {
        return $this->customerEnquiryRepo->getCustomerProPosalVersionByID($id, $proposal_id, $Vid);
    }
    public function update(Request $request, $id, $proposal_id)
    {
        return $this->customerEnquiryRepo->updateCustomerProPosalByID($id, $proposal_id, $request);
    }
    public function updateVersions(Request $request, $id, $proposal_id, $Vid)
    {
        return $this->customerEnquiryRepo->updateCustomerProPosalVersionByID($id, $proposal_id, $request, $Vid);
    }
    public function deleteVersions(Request $request, $id, $proposal_id, $Vid)
    {
        return $this->customerEnquiryRepo->deleteCustomerProPosalVersionByID($id, $proposal_id, $request, $Vid);
    }
    public function destroy(Request $request, $id, $proposal_id)
    {
        return $this->customerEnquiryRepo->deleteCustomerProPosalByID($id, $proposal_id, $request);
    }
    public function duplicate(Request $request, $id, $proposal_id)
    {
        return $this->customerEnquiryRepo->duplicateCustomerProPosalByID($id, $proposal_id, $request);
    }
    ...
    {
        return $this->customerEnquiryRepo->getCustomerProPosalVersions($id, $proposal_id, $request);
    }
    public function sendMail(Request $request, $id, $proposal_id)
    {
        ...
        return $this->customerEnquiryRepo->sendCustomerProPosalMail($id, $proposal_id, $request);
    }
    public function sendMailVersion(Request $request, $id, $proposal_id, $Vid)
    {
        $enquiry = Enquiry::find($id);
        $this->customerEnquiryRepo->updateAdminWizardStatus($enquiry, 'proposal_email_status');
        return $this->customerEnquiryRepo->sendCustomerProPosalMailVersion($id, $proposal_id, $request, $Vid);
    }

    public function sendProposal($id)
    {
        $proposal =  EnquiryProposal::where(['enquiry_id' =>  $id, 'admin_status' => 'AWAITING'])->latest()->first();
        $enquiry  = Enquiry::with('customer')->find($id);
        if (is_null($proposal)) {
            return response(['status' => false, 'msg' => __('enquiry.generate_proposal')]);
        }
        $enquiry->version     = $proposal->version;
        $enquiry->proposal_id = Crypt::encryptString($proposal->id);
        try {
            Mail::to($enquiry->customer->email)->send(new \App\Mail\ProposalMail($enquiry));
        } catch (Exception $ex) {
            Log::info($ex->getMessage());
        }
        Enquiry::find($id)->update([
            "is_new_enquiry"          => true,
            "proposal_sharing_status" => true,
            "proposal_email_status"   => true
        ]);
        updateEnquiryProposalsStatus($id);
        $proposal->update([
    ...
    {
        $proposal = EnquiryProposal::findOrFail(Crypt::decryptString($id));
        return view('admin.enquiry.approvals.proposal', compact('proposal'));
    }
