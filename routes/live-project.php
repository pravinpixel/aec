...
Route::group(['prefix' => 'live', 'middleware' => 'common'], function () { 
    ...
    Route::post('/create-task/{project_id?}', [LiveProjectController::class, 'create_task'])->name('live-project.task-list-create');
    Route::delete('/delete-task/{task_id?}', [LiveProjectController::class, 'delete_task'])->name('live-project.task-list-delete');
