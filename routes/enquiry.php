...
Route::group(['prefix' => 'technical-estimate', 'middleware' => 'common', 'route' => 'technical-estimate'], function(){
    ...
    Route::get('get-history/{id}/{type}', [TechEstimateController::class, 'getHistory'])->name('get-history');
});
...
Route::group(['prefix' => 'admin', 'middleware' => 'common', 'route' => 'admin'], function(){
  ...
  Route::delete('enquiry-proposal/{id?}', [EnquiryProposalController::class,'delete'])->name('enquiry-proposal.delete');
