                                                        ...
                                                        <div class="accordion mb-3 " id="accordionTable_@{{ Secindex }}_@{{ fIndex  }}" >
                                                           ...
                                                           {{-- <button class="btn btn-info float-end"  ng-click="AddWallDetails(fIndex)"><i class="fa fa-plus"></i> Add Floor</button> --}}
                                                            <div class="accordion-item shadow-sm  ">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr ng-repeat="(ThreeIndex,l) in d.Layers">
                                                                                            ...
                                                                                            <td class="text-center">
                                                                                                <div class="btn-group">
                                                                                                    <!-- Danger Header Modal -->
                                                                                                    <button ng-click="confirmRemove(fIndex, Secindex, ThreeIndex)"  type="button" class="btn btn-outline-danger rounded shadow-sm btn-sm"  ><div class="fa fa-trash " ></div></button>
                                                                ...
                                                                <div id="ConfirmDelete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ConfirmDeleteLabel" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" ng-click="okDelete()">Yes, delete it !</button>
                                                                            </div>
                                                                        </div><!-- /.modal-content -->
                                                                    </div><!-- /.modal-dialog -->
                                                                </div><!-- /.modal -->
...
@push('custom-scripts')
    ...
    <script>
        angular.module('App', []).controller('CrudCtrl', ['$scope', function($scope) {
            ...
            $scope.confirmRemove = function (fIndex, Secindex, ThreeIndex){
                id_one      = fIndex ;
                id_two      = Secindex ;
                id_three    = ThreeIndex ;
            ...
            $scope.okDelete = function() {
                console.log(id_one , id_two , id_three);
                $scope.wallGroup[id_one].Details[id_two].Layers.splice(id_three,1);
            }
