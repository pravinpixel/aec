...
class BuildingComponentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $partitionWall = BuildingComponent::create(['building_component_name' => 'Fire and Sound', 'building_component_icon' =>'uil uil-wall', 'top_position'=> '',  'bottom_position'=> '', 'order_id'=> 3, 'is_active' => 1]);
        $ceiling = BuildingComponent::create(['building_component_name' => 'Ceiling', 'building_component_icon' =>'uil uil-layers', 'top_position'=> 'Top',  'bottom_position'=> 'Bottom', 'order_id'=> 4,'is_active' => 1]);
        $roof = BuildingComponent::create(['building_component_name' => 'Roof',  'building_component_icon' =>'uil uil-mountains-sun', 'top_position'=> '',  'bottom_position'=> 'Interior', 'order_id'=> 5, 'is_active' => 1]);
