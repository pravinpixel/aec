...
class CreateEnquiryBuildingComponentDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('enquiry_bcds', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('enquiry_building_component_id');
            $table->unsignedBigInteger('building_component_delivery_type_id');
            $table->string('floor');
            ...
            $table->foreign('building_component_delivery_type_id')->references('id')->on('building_component_delivery_types');
            $table->timestamps();
        });
    }
