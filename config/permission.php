...
return [
    ...
    'permission_styles' => [
        'dashboard'                 => 'px-0',
        'enquiry_dashboard'         => 'px-2 text-secondary',
        'project_dashboard'         => 'px-2 text-secondary',
        'economy_dashboard'         => 'px-2 text-secondary',
        'employee_performance'      => 'px-2 text-secondary',
        'sale'                      => 'px-0',
        'enquiry'                   => 'px-2 text-secondary',
        'technical_estimate'        => 'px-2 text-secondary',
        'cost_estimate'             => 'px-2 text-secondary',
        'proposal_sharing'          => 'px-2 text-secondary',
        'customer_response'         => 'px-2 text-secondary',
        'contract'                  => 'px-2 text-secondary',
        'project'                   => 'px-2 text-secondary',
        'task'                      => 'px-0',
        'project'                   => 'px-0',
        'task'                      => 'px-0',
        'issues'                    => 'px-0',
        ...
        'project_schedule'          => 'px-2 text-secondary',
        'project_summary'           => 'px-2 text-secondary',
        'cost_estimate_calculation' => 'px-2 text-secondary',
        'gantt_chart'               => 'px-2 text-secondary',
        'employee'                  => 'px-2 text-secondary',
        'administrator'             => 'px-0',
    ]
];
