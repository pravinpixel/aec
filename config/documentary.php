...
return [
    ...
    'merge_data' =>  [ 
        'Project Details' => [
            ...
            "Project Name"           => "project_name",
            "Street Name"            => "project_street_name",
            "City"                   => "project_city",
            "State"                  => "project_state",
            "Country"                => "project_country",
            "Zip Code"               => "project_zipcode",
            "No of Buildings"        => "no_of_building",
            "Project Start Date"     => "project_date",
            "Project Delivery Date"  => "project_delivery_date",
            "Project In-charge Name" => "project_in_charge_name",
            "Phone No"               => "project_mobile_no"
        ],
        'Customer Details' => [
            'Company Name'        => "company_name",
            'Organization No'     => 'customer_organization_no',
            "Street Name"         => "customer_street_name",
            "City"                => "customer_city",
            "State"               => "customer_state",
            "Country"             => "customer_country",
            "Zip Code"            => "customer_zipcode",
            'Contact Person Name' => "contact_person",
            'E-mail'              => "customer_email",
            "Phone No"            => "customer_mobile_no"
        ],
        'Admin Details' => [
            'Name'               => "admin_name",
            'Role No'            => 'admin_role',
            'E-mail'             => 'admin_email',
            "Phone No"           => "admin_mobile_no",
        ...
        'Building Component and Price Details' => [
            "Calculated Total Price" => "calculated_total_price",
            "Building comp-1 Name "  => "building_comp_1_name ",
            "Building comp-2 Name"   => "building_comp_2_name",
            "Building comp-3 Name "  => "building_comp_3_name ",
            "Building comp-4 Name"   => "building_comp_4_name",
            "Building comp-1 Area"   => "building_comp_1_area",
            "Building comp-2 Area"   => "building_comp_2_area",
            "Building comp-3 Area"   => "building_comp_3_area",
            "Building comp-4 Area"   => "building_comp_4_area",
        ],
        'Offer doc Details' => [
